...
OUT_FILE = OUT_DIR / f"weekly_bullish_marubozu_{today}.csv"

# ==============================
# PARAMETERS (UPDATED)
# ==============================
MIN_BODY_RATIO = 0.70      # relaxed from 0.80
WICK_TOLERANCE = 0.005     # relaxed from 0.002
